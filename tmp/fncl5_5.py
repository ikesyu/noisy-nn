...
生成物 (out/fncl5_5/):
  table_final_mse.md      -> Tab.1 の uniform 行 (または別表)
...
実行例:
  python tmp/fncl5_5.py
  python tmp/fncl5_5.py --radius 1.0 --quick
"""
import argparse
...
def main() -> None:
    p = argparse.ArgumentParser(
        description="§5.5 uniform-noise reproduction of the main result.")
    add_common_args(p)
    args = finalize_args(p.parse_args(), default_out="out/fncl5_5")
